...
//./o input=input31.txt command=command31.txt output=output31.txt
//./o input=input32.txt command=command32.txt output=output32.txt
//./o input=input33.txt command=command33.txt output=output33.txt
//./o input=input34.txt command=command34.txt output=output34.txt
//./o input=input35.txt command=command35.txt output=output35.txt
//./o input=input36.txt command=command36.txt output=output36.txt
//./o input=input37.txt command=command37.txt output=output37.txt
//./o input=input38.txt command=command38.txt output=output38.txt
//./o input=input39.txt command=command39.txt output=output39.txt
	...
	while (getline(file2, str))
	{
		...
		else if (command == "add")
		{
			...
			if (command == "at")
			{
				...
				if (command == "end")
				{	
					while(file2.peek()!="add"||file2.peek()!="sort"||file2.peek()!="delete"||file2.peek()!="output")
					{
						getline(file2, str);
